<style>
    ...
    <div class="tags btn" id="t1" onclick="showPost('#p1')">健康新知</div><div 
    class="tags btn" id="t2" onclick="showPost('#p2')">菸害防治</div><div 
    class="tags" id="t3" onclick="showPost('#p3')">癌症防治</div><div 
    class="tags" id="t4" onclick="showPost('#p4')">慢性病防治</div>
<article id="p1">
    <h2>健康新知</h2>
    <pre>
